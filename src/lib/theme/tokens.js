...
const color = {
  ...
  primaryTint10: mixHex(palette.white, palette.mauve, 0.1),
  primaryTint20: mixHex(palette.white, palette.mauve, 0.2),
  primaryTint30: mixHex(palette.white, palette.mauve, 0.3),
  primaryTint40: mixHex(palette.white, palette.mauve, 0.4),
  primaryTint50: mixHex(palette.white, palette.mauve, 0.5),
  primaryShade10: mixHex(palette.pureblack, palette.mauve, 0.1),
  primaryShade20: mixHex(palette.pureblack, palette.mauve, 0.2),
  primaryShade30: mixHex(palette.pureblack, palette.mauve, 0.3),
  primaryShade40: mixHex(palette.pureblack, palette.mauve, 0.4),
  primaryShade50: mixHex(palette.pureblack, palette.mauve, 0.5),
  primaryA10: rgba(palette.mauve, 0.1),
  primaryA20: rgba(palette.mauve, 0.2),
  primaryA30: rgba(palette.mauve, 0.3),
  primaryA40: rgba(palette.mauve, 0.4),
  primaryA50: rgba(palette.mauve, 0.5),
  primaryA60: rgba(palette.mauve, 0.6),
  primaryA70: rgba(palette.mauve, 0.7),
  primaryA80: rgba(palette.mauve, 0.8),
  primaryA90: rgba(palette.mauve, 0.9),
  primaryA100: rgba(palette.mauve, 1),
