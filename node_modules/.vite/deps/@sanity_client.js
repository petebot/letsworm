...
var parseHeaders$1 = getDefaultExportFromCjs(parseHeaders);
...
var debugIt = getDefaultExportFromCjs(browserExports);
...
var Cancel = class {
  constructor(message) {
    __publicField2(this, "__CANCEL__", true), __publicField2(this, "message"), this.message = message;
  }
  toString() {
...
var _CancelToken = class {
  constructor(executor) {
    if (__publicField2(this, "promise"), __publicField2(this, "reason"), typeof executor != "function")
...
var sharedRetry = (opts) => {
  ...
  return {
    onError: (err, context2) => {
      const options = context2.options, max2 = options.maxRetries || maxRetries, delay2 = options.retryDelay || retryDelay, shouldRetry2 = options.shouldRetry || allowRetry, attemptNumber = options.attemptNumber || 0;
      ...
      return setTimeout(() => context2.channels.request.publish(newContext), delay2(attemptNumber)), null;
    }
  };
};
...
function buildKeepAlive(agent2) {
  return function(config2 = {}) {
    const ms2 = config2.ms || 1e3, maxFree = config2.maxFree || 256;
    return agent2({
      keepAlive: true,
      keepAliveMsecs: ms2,
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-A5S72KL3.js").then(function(n) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-WGKJO4D4.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events() {
    ...
    return new Observable((observer) => {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" ? (await import("./browser-WGKJO4D4.js")).default : EventSource;
        if (unsubscribed)
          return;
